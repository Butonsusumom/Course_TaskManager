                   ...
                   Rectangle {
                       ...
                       color: if(styleData.date !== undefined && styleData.selected){
                                  ...
                                  tableSchedule.selection.clear()
                                   tableSchedule.currentRow =-1
                                  tableView.selection.clear()
                                   tableView.currentRow =-1
                                 "#ff7f50"
                              }else if(styleData.date !== undefined &&
                                       Qt.formatDate(styleData.date, "yyyyMMdd") == curDate) "peachpuff"
                              else "transparent"
           ...
           Rectangle {
               ...
               Button {
                   ...
                   style: ButtonStyle {
                           background: Rectangle {
                               ...
                               border.color: control.pressed ? "#ff7f50" : "transparent"
                               color: '#ffa07a'
                           }
                           label: Text {
                                   verticalAlignment: Text.AlignVCenter
               ...
               TableView {
                   ...
                   rowDelegate: Rectangle {
                       height: 20
                       color: styleData.selected ? "#ffa07a" : 'white';
                       MouseArea {
                           id: mouseArea
                           anchors.fill: parent
                           ...
                           onClicked: {
                               if(styleData.row >= 0) {
                                   tableSchedule.selection.clear()
                                    ...
                                    tableSchedule.currentRow = styleData.row
                               }
