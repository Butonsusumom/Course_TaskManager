...
Dialog {
     ...
     function defval() {
        //
         //dateShcedule.text = Qt.formatDate(calendar.selectedDate, "dd-MM-yyyy")
         titleShcedule.text = ""
     ...
     onApply: {
         if(startShcedule.text < endShcedule.text) {
             database.inserIntoTable("shcedule", startShcedule.text, endShcedule.text,Qt.formatDate(calendar.selectedDate,  "yyyyMMdd"),
     ...
     ColumnLayout {
         ...
         RowLayout {
            ...
            /* RowLayout {
             ...
             TextField{
                 id: dateShcedule
                 text: Qt.formatDate(calendar.selectedDate, "ddMMyyyy")
