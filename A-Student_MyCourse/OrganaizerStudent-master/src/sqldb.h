...
#define TABLE_SCHEDULE_DATE         "ScheduleDate"
...
public slots:
    ...
    void updatestatus(const QString &id, const QString &status); // Обновляем статус задачи
    void updatedate(const QString &id, const QString &deadlineday);
    void updatetime(const QString &id, const QString &deadlinetime);
    void updatestart(const QString &id, const QString &start);
    void updateend(const QString &id, const QString &end);
